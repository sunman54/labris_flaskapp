...
application.config['SQLALCHEMY_DATABASE_URI'] = user_connect.dbConfig
...
@application.route('/user/list', methods=['GET'])
...
@application.route('/user/delete/<int:id>', methods=['GET'])
...
@application.route('/user/update/', methods=['POST', 'GET'])
...
@application.route('/onlineusers', methods=['GET'])
